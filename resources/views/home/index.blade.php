...
<div class="d-flex flex-column flex-md-row gap-3 align-items-md-center justify-content-between mb-3">
    <div>
        <h1 class="h4 mb-1">Свежие рецепты</h1>
        <div class="text-muted">Выбирайте по дате добавления и сложности</div>
    </div>
    ...
    <div class="dropdown">
        ...
        <div class="dropdown-menu dropdown-menu-end p-3" style="min-width: 280px;">
            <form class="d-grid gap-3">
                <div>
                    <label class="form-label mb-1">По дате добавления</label>
                ...
                <div>
                    <label class="form-label mb-1">По сложности</label>
                    <select class="form-select">
                        <option>Любая</option>
                        <option>Легко</option>
                ...
                <div class="d-flex gap-2">
                    <button class="btn btn-primary w-100" type="button">Применить</button>
                    <button class="btn btn-outline-secondary w-100" type="button">Сброс</button>
                </div>
            </form>
        </div>
    </div>
